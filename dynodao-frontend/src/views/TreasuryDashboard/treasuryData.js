...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all SEA staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing SEA.",
  ...
  holder: "Holders, represents the total number of Ohmies (WAVE holders)",
  staked: "SEA Staked, is the ratio of WAVE to SEA (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days WAVE emissions can be sustained at a given rate. Lower APY = longer runway",
};
