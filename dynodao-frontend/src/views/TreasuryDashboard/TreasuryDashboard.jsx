            ...
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              ...
              <Box className="metric index">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of WAVE accumulated since the beginning of staking. Basically, how much WAVE one would have if they staked and held a single OHM from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
                  {currentIndex ? trim(currentIndex, 2) + " WAVE" : <Skeleton type="text" />}
                </Typography>
              </Box>
            </Box>
          </Paper>
          ...
          <Grid container spacing={2} className="data-grid">
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Paper className="ohm-card">
                ...
                <Typography className="titleColor">
                  SEA Price
                </Typography>
                {/* <Chart
                  type="area"
                  ...
                  headerSubText={`${
                    data && formatCurrency(data[0]?.totalValueLocked)
                  }`}
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Paper className="ohm-card">
                ...
                <Typography className="titleColor">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of WAVE accumulated since the beginning of staking. Basically, how much WAVE one would have if they staked and held a single SEA from day 1."
                    }
                  />
                </Typography>
                {/* <Chart
