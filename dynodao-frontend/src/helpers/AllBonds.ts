...
import { ReactComponent as OhmDaiImg } from "src/assets/ohm/SEA-USDT.svg";
...
// export const dai_ = new StableBond({
//   name: "BUSD",
//   displayName: "BUSD",
//   bondToken: "BUSD",
//   bondIconSvg: DaiImg,
...
export const dai = new StableBond({
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0x12a84Fb1763F89E352CDAD6748B921815051B3AF",
      reserveAddress: addresses[NetworkID.Mainnet].DAI_ADDRESS,
    },
    [NetworkID.Testnet]: {
      bondAddress: "0x4467376E6c472A8D33897062BF946cc4aaF64ec1",
      reserveAddress: "0xD6BF8FEEDd8E3eb0499B25CAbA720dC5A7a09410",
    },
  },
});
...
//     },
//   },
//   customTreasuryBalanceFunc: async function (
//     this: CustomBond,
//     networkID,
//     provider
//   ) {
...
//     let ethAmount = await token.balanceOf(
...
//     },
//   },
//   lpUrl: `https://pancakeswap.finance/add/${
//     addresses[NetworkID.Mainnet].DAI_ADDRESS
//   }/${addresses[NetworkID.Mainnet].SEA_ADDRESS}`,
// });
export const ohm_dai = new LPBond({
  name: "SEA-USDT",
  displayName: "SEA-USDT LP",
  bondToken: "SEA-USDT",
  bondIconSvg: OhmDaiImg,
  bondContractABI: BondOhmDaiContract,
  reserveContract: ReserveOhmDaiContract,
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0xBFA24eb9d121B5d155b62B44517c19d558066Db7",
      reserveAddress: "0xBDAda1C54d9125f455a452E3707a16804083B3a0",
    },
    [NetworkID.Testnet]: {
      bondAddress: "0x97Ab19f1293aB81A31Ed82feEB969527e82Bd61A",
      reserveAddress: "0x42cEfFD2E431ad80d9CBBadDF4A738D87550a150",
    },
  },
  lpUrl: `https://swap-testnet.bitdeep.dev/#/add/${
    addresses[NetworkID.Mainnet].DAI_ADDRESS
  }/${addresses[NetworkID.Mainnet].SEA_ADDRESS}`,
});
...
export const treasuryBalanceAll = async (
  networkID: NetworkID,
  provider: StaticJsonRpcProvider
) => {
  return (
    await Promise.all(
      allBonds.map(async (item) => {
