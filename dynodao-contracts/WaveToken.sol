...
contract WaveToken is ERC20PermitUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        __ERC20_init("OceansDao Rebase Token", "WAVE");
        __Ownable_init();
    ...
    function setInitialInfo( address stakingContract_ ) external onlyOwner() returns ( bool ) {
        require( msg.sender == initializerAddress, "NA" );
