...
export const loadAppDetails = createAsyncThunk(
  ...
  async ({ networkID, provider }: IBaseAsyncThunk, { dispatch }) => {
    ...
    // const sohmOldContract = new ethers.Contract(addresses[networkID].OLD_WAVE_ADDRESS as string, sOHM, provider);
    ...
    console.log("Here AppSlice - Total Supply:", totalSupply);
    console.log("Here AppSlice - circ Supply:", circ.toString());
    ...
    console.log("Here in AppSlice - circSupply : ", circSupply);
