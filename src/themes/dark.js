...
const darkTheme = {
  ...
  gold: "#ffe300",
  gray: "#00c4ff",
  textHighlightColor: "#00a8fd",
  background: "linear-gradient(40deg, #1c5795 10%, #07313a 70%)",
  ...
  createTheme(
    {
      ...
      overrides: {
        ...
        PrivateTabIndicator: {
          colorPrimary: {
            backgroundColor: darkTheme.tabSelect,
          },
        },
        MuiToggleButton: {
          root: {
        ...
        MuiButton: {
          ...
          outlinedPrimary: {
            color: darkTheme.tabSelect,
            borderColor: darkTheme.tabSelect,
            "&:hover": {
              color: darkTheme.color,
              backgroundColor: darkTheme.buttonBg,
              // color: darkTheme.outlinedPrimaryButtonHoverColor,      //For Bond Page Button
              // backgroundColor: darkTheme.primaryButtonHoverBG,
            },
            "@media (hover:none)": {
              color: darkTheme.tabSelect,
