...
function Stake() {
  ...
  const onChangeStake = async (action) => {
    ...
    if (
      ...
      return dispatch(error("You cannot stake more than your SEA balance."));
    }
    ...
    if (
      ...
      return dispatch(
        error("You cannot unstake more than your WAVE balance.")
      );
    }
              ...
              <div className="card-header">
                ...
                {address && oldSohmBalance > 0.01 && (
                  ...
                  >
                    ...
                    <Typography>Migrate WAVE!</Typography>
                  </Link>
                )}
              </div>
            </Grid>
              ...
              {!address ? (
                <div className="stake-wallet-notification">
                  ...
                  <Typography variant="h6">
                    Connect your wallet to stake SEA
                  </Typography>
                </div>
              ) : (
                <>
