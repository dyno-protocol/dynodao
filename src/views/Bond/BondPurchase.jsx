    ...
    if (quantity === "") {
      ...
      const shouldProceed = window.confirm(
        `You are trying to purchase Bond for the address ${shorten(
          recipientAddress
        )}, please ensure the wallet address has connected to 33DAO to view the Bond information after purchase succeeds.`
      );
      if (shouldProceed) {
        await dispatch(
          bondAsset({
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {isBondLoading ? (
                ...
                `${trim(bond.maxBondPrice, 4) || "0"} SEA`
              )}
            </Typography>
          </div>
